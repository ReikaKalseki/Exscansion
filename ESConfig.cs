...
namespace ReikaKalseki.Exscansion {
	public class ESConfig {
		public enum ConfigEntries {
			[ConfigEntry("Leviathans Need To Be Scanned Before Scanner Room Detection", true, true)]LEVISCAN, //Whether the scanner room can only find leviathans after you scan them "in person"
			[ConfigEntry("Scanner Room Can Detect Time Capsules", false, true)]TIMECAPSULE,
			...
			[ConfigEntry("Resources Need To Be Scanned Before Scanner Room Detection", true, true)]RESSCAN,
			[ConfigEntry("Stalker Teeth To Be Scanned Before Scanner Room Detection", false, true)]TOOTHSCAN,
